"""OfferCare clinician Terms of Service — versioned worker agreement for /join apply flow."""

from __future__ import annotations

WORKER_TERMS_VERSION = "2026-06-21"
WORKER_TERMS_EFFECTIVE_DATE = "June 21, 2026"
WORKER_TERMS_TITLE = "OfferCare.ai Clinician Terms of Service"

WORKER_TERMS_SECTIONS: tuple[tuple[str, str], ...] = (
    (
        "1. Agreement & eligibility",
        "By applying through OfferCare.ai you agree to these Terms of Service. "
        ...
        "You apply voluntarily — OfferCare does not recruit you from scraped contact lists.",
    ),
    (
        "2. W-2 employment & shift model",
        "OfferCare classifies matched floor staff as W-2 employees for per-diem nursing home shifts, "
    ...
    (
        ...
        "You authorize OfferCare to verify your Maryland license through MBON, screen you against the "
    ...
    (
        ...
        "When a local nursing home needs coverage, OfferCare may contact you by SMS, email, and/or "
    ...
    (
        ...
        "remaining fit for duty, and reporting incidents to the facility DON and OfferCare operations.",
    ),
    (
        "7. Pay & taxes",
        "Pay rates are shown before you lock a shift. W-2 wages are subject to payroll withholding. "
        "OfferCare does not guarantee minimum hours, shift volume, or annual income.",
    ),
    (
        "8. Suspension & termination",
        "OfferCare may suspend or terminate your portal access for failed credential checks, exclusion "
    ...
    (
        "9. Privacy",
        "OfferCare stores your application, credentialing results, shift history, and communications "
    ...
    (
        ...
        "OfferCare connects licensed clinicians with facilities needing coverage. Facilities control "
        "on-site supervision and clinical direction. To the fullest extent permitted by law, OfferCare "
    ...
    (
        "12. Contact",
        "Questions about these Terms: compliance@offercare.ai. Maryland operations: share your application "
        "ID from the clinician portal when contacting support.",
    ),
)

CONSENT_TERMS_OF_SERVICE = (
    f"I have read and agree to the OfferCare.ai Clinician Terms of Service "
