...
def build_twilio_sms_production_runbook(db: Session) -> dict:
    ...
    env_lines = [
        "# Twilio live SMS production (VettedMe step 135)",
        "SMS_DRY_RUN=false",
    ...
    steps = [
        ...
        f"Twilio Console → Phone Numbers → your VettedMe number → Messaging → A MESSAGE COMES IN",
    ...
    return {
        ...
        "metrics": {
            ...
            "twilio_console_steps": [
                "Twilio Console → Phone Numbers → Manage → Active numbers → select your VettedMe number",
