...
# 1. Dedicated Production VPC for VettedMe.ai
resource "aws_vpc" "vettedme_prod_vpc" {
  cidr_block           = "10.0.0.0/16"
  enable_dns_hostnames = true
  enable_dns_support   = true

  tags = {
    Name        = "vettedme-prod-vpc"
